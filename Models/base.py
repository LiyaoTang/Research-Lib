...
class Base_Tracker(Base_Model):
    ...
    def track_init(self, image, starting_box, unique_id=None):
        '''
        initialize the tracker with 1st frame image
        '''
        raise NotImplementedError
    
    def track(self, img_list, starting_box, unique_id=None):
        '''
    ...
    def track_fix(self, image, label_box, unique_id):
        '''
        fix the result of frame t-1, before tracking on frame t
        '''
        raise NotImplementedError

    def inference(self, img_list, starting_box, unique_id=None):
        '''
        inference <=> track
        '''
        return self.track(img_list, starting_box, unique_id)